...
void DmaSetXferSize(PDMA_REGS pdreg, DMA_DIRC dirc, uint8_t chnl,
			uint32_t size);
...
void DmaSetCtrl(PDMA_REGS pdreg, DMA_DIRC dirc, uint8_t chnl,
			DMA_XFER_MODE mode);
...
void DmaGetChanStatus(PDMA_REGS pdreg, DMA_DIRC dirc, uint8_t chnl,
			DMA_CHAN_STATUS *status);
void DmaGetXferSize(PDMA_REGS pdreg, DMA_DIRC dirc, uint8_t chnl,
			uint32_t *size);
